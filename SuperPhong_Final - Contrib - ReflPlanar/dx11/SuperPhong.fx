...
{	
	...
	int diffuseMode <string uiname="DiffuseAffect: Reflection/Specular/Both"; int uimin=0.0; int uimax=2.0;> = 2;
};
...
///////////////////////////////////////
	...
	if(reflectMode == 0){
		...
		//newCol = lerp(newCol, reflectionColor, reflective.y);
	...
	//col = lerp(col, reflectionColor, 0.55f);
    return col;
}
