...
float4 PS_SuperphongReflective(vs2ps In): SV_Target
{	
...
technique10 Superphong_Reflective
{
	pass P0
	{
		SetVertexShader( CompileShader( vs_4_0, VS_Reflective() ) );
		SetPixelShader( CompileShader( ps_4_0, PS_SuperphongReflective() ) );
	}
}